    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="button-box pull-right" style="padding-bottom:10px;">
                <a href="{{ url('teacher/add') }}" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus m-r-5"></i> <span>Add New Teacher</span></a>
            </div>
                ...
                <table class="table table-hover manage-u-table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('teacher/edit/'.$model->id) }}" type="button" class="btn btn-info btn-outline btn-circle btn-sm m-r-5"><i class="ti-pencil-alt"></i></a>
                                <a href="{{ url('teacher/delete/'.$model->id) }}" type="button" class="btn btn-danger btn-outline btn-circle btn-sm m-r-5"><i class="fa fa-remove"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
